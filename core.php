...
class Twig_Extension_Core extends Twig_Extension
{
    ...
    public function getFunctions()
    {
        return array(
			...
			new Twig_SimpleFunction('base64en', 'cs_base64_encode'),
            new Twig_SimpleFunction('shuffle', 'cs_shuffle'),
            new Twig_SimpleFunction('str_text', 'cs_str_text'),
			new Twig_SimpleFunction('source_url', 'source_url'),
...
function cs_base64_encode($value)
{
...
function cs_shuffle($array)
{
	shuffle($array);
	return $array;
}

function cs_str_text($value)
{
	return str_replace( '-', ' ', sanitize_title($value) );
}
